...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaW5ndmlsbGFqaW1lbmV6IiwiYSI6ImNsdHowZ200YzBtdmkya3F3bWY0aXE4cmgifQ.IwBPIVKoG8LsTgu-9PKe0g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/ingvillajimenez/cltz7m3jq01w401pb8k4o4bs5',
...
var stripe = Stripe('pk_test_TFvfAEmFeq8Dov8MNL136Nqy');
...
// DOM ELEMENTS
var mapbBox = document.getElementById('map');
...
if (mapbBox) {
  var locations = JSON.parse(mapbBox.dataset.locations);
